...
@section('title', __('app.test.edit'))

@section('content')
  <div class="content content--split">
    <div class="heading-action mb-8">
      <h1 class="heading heading--2 d-inline-block">{{ __('app.test.edit') }}</h1>
    </div>
    <div class="content__wrapper">
      <form action="{{ route('admin.test.update', ['test' => $test->id]) }}" id="main_form" method="POST">
        @csrf
        @method('PUT')
