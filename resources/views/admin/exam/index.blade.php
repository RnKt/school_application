...
@section('content')
  <div class="content">
    <div class="heading-action mb-8">
      <h1 class="heading heading--2 d-inline-block">{{ __('app.exam.title.many') }}</h1>
      <a href="{{ route('admin.exam.create') }}"
         class="heading-action__button button button--small">{{ __('app.exam.create') }}</a>
    </div>
    <div class="content__wrapper">
      <form action="{{ route('admin.exam.delete') }}" method="POST" id="main_form">
        @csrf
        <table class="table mb-8">
          ...
          @foreach($exams as $exam)
            <tr class="table__row" data-id="{{ $exam->id }}">
              <td class="table__cell">
                <div class="table__cell-content align-center">
                  <div class="checkbox-wrapper mx-center">
                    <input type="checkbox" class="checkbox pseudo" name="exams[]" value="{{ $exam->id }}"/>
              ...
              <td class="table__cell">
                <a href="{{ route('admin.exam.show', ['exam' => $exam->id]) }}"
      ...
      @include('admin.parts.pagination', ['currentUrl' => 'admin.exam.index'])
    </div>  
  </div>
@endsection
