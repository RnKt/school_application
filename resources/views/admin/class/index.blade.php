...
@section('content')
  <div class="content">
    <div class="heading-action mb-1">
      <h1 class="heading heading--2 d-inline-block">{{ __('app.class.title.many') }}</h1>
      <a href="{{ route('admin.class.create') }}"
         class="heading-action__button button button--small">{{ __('app.class.create') }}</a>
    </div>
    <div class="content__wrapper">
      <form action="{{ route('admin.class.action') }}" method="POST" id="main_form">
        @csrf
        ...
        <table class="table mb-8">
          ...
          <tr class="table__row table__row--head">
            ...
            <th class="table__cell table__cell--head">
              <div
                class="table__cell-content table__cell-content--head">{{ __('app.manage.students') }}</div>
            </th>
          ...
          @foreach($classes as $class)
            <tr class="table__row" data-id="{{ $class->id }}">
              <td class="table__cell">
                <div class="table__cell-content align-center">
                  <div class="checkbox-wrapper mx-center">
                    <input type="checkbox" class="checkbox pseudo" name="classes[]" value="{{ $class->id }}"/>
              ...
              <td class="table__cell">
                <a href="{{ route('admin.class.show', ['class' => $class->id]) }}"
